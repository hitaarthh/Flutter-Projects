...
// Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory(int userChoice) {
    if (_storyNumber == 0) {
      ...
      if (userChoice == 1)
        _storyNumber = 2;
      else if (userChoice == 2) _storyNumber = 3;
    } // Case 1
    else if (_storyNumber == 2) {
      if (userChoice == 1)
        _storyNumber = 5;
      else if (userChoice == 2) _storyNumber = 4;
    } // Case 2
    else if (_storyNumber == 3 ||
        _storyNumber == 4 ||
        _storyNumber == 5) // Case 3
      restart();
  }
