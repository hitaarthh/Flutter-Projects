...
import 'story.dart'; //ignore: unused_import
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            ...
            fit: BoxFit
                .cover, //To fit image in whole device screen, if we won't use this the image will be only present in SafeArea of the screen.
          ),
        ),
